...
public class ElementOperations implements GlobalVariables {
	...
	public WebElement getElementByFluent(WebDriver driver, String locType, String locValue) throws InvalidLocatorException {
		Wait<WebDriver> fluentWait = new FluentWait<WebDriver>(driver)
		        .withTimeout(Duration.ofSeconds(fluentWaitTime))
		        .pollingEvery(Duration.ofSeconds(poolTime))
